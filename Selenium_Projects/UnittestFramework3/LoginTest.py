...
if __name__=="__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="A:\\Automation\\Selenium_using_python\\Selenium_Projects\\UnittestFramework3\\Reports2"))

# for report - add html-testRunner